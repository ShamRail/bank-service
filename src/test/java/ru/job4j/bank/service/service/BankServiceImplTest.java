...
import ru.job4j.bank.service.BankServiceApplication;
...
@SpringBootTest
@RunWith(SpringRunner.class) /* Необходимо т.к. мы используем JUnit4 */
public class BankServiceImplTest {
    ...
    public void whenSuccessCredit() {
        ...
        Credit credit = new Credit(
                LocalDateTime.now().plusDays(1), LocalDateTime.now().plusMonths(12), 200_000, (byte) 10
        );
